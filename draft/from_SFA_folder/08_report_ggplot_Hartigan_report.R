#
# 08_report_ggplot_Hartigan_report.R 
#
...
FL.LOG <- paste(Path.LOG,"08_report_ggplot_Hartigan_report.log",sep="/")
...
for (this.year.alt in c(2011,2010,20100)[1])
{
	...
	Path.results <- paste(Path.Project,"08_report_ggplot_Hartigan_report",this.year.string,sep="/")
...
cat(paste("\n08_report_ggplot_Hartigan_report.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n08_report_ggplot_Hartigan_report.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [08_report_ggplot_Hartigan_report.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [08_report_ggplot_Hartigan_report.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
