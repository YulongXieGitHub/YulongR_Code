...
FL.LOG <- paste(Path.LOG,"5_report_ggplot_Hartigan.log",sep="/")
...
for (this.year.alt in c(2011,2010,20100))
{
	...
	Path.results <- paste(Path.Project,"5_report_ggplot_Hartigan",this.year.string,sep="/")
...
cat(paste("\n05_report_ggplot_Hartigan.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n05_report_ggplot_Hartigan.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [05_report_ggplot_Hartigan.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [05_report_ggplot_Hartigan.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
