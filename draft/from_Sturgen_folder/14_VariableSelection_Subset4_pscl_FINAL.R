#
# 14_VariableSelection_Subset4_pscl_final.R
#
...
FL.LOG    <- paste(Path.log,"14_VariableSelection_Subset4_pscl_final.log",sep="/")	
...
FL.RESL.OUT <- paste(Path.OUT,"14_VariableSelection_Subset4_pscl_final.csv",sep="/")
...
for (idx.subset in c(4))
{
	...
	# subset 3: lower OT & TN	[myData.Lower_Active]
		...
		Y.var  <- "Pal_cnt"
		var.rm.fix <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist","Rel_dsch_AY","Rel_dsch_WY","gear.type1","gear.type2","CPUA.calc")
	...
	# subset 4: lower TLC [myData.Lower_TLC]
		...
		Y.var  <- "Pal_cnt"
		var.rm.fix <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist","Rel_dsch_AY","Rel_dsch_WY","gear.type1","gear.type2","CPUE.calc","D_dist_up")																		# D_dist_up is completed correlated with "GIS_RM"
		# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up")																		# 1-6 variables
		# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","VF_wid","Rel_dsch_AY","new_meso","new_part")				# 7 variables
		# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","Wet_wid","Comp_per","Rel_dsch_AY","new_part")				# 8 variables
		# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","Wet_wid","T_dist_near","Grade_10_RM","Temp","new_meso","new_lith")	# 9 variables
	  	# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","Wet_wid")									# 10 variables
		# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","Wet_wid","VF_wid","Temp","MicroClass")					# 11 variables
		  var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","Wet_wid","T_dist_near","Grade_10_RM","Temp")			# 12 variables
		# var.rm     <- c("Gear","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","D_dist_up","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","T_dist_dn","Wet_wid","Clay_per","Comp_per")		# 13 variables
	...
	if(idx.subset == 4)	# PSCL Lower TLC
	{
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 4 Lower TLC]: 1. model with 1 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 4 Lower TLC]: 2. model with 2 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 4 Lower TLC]: 3. model with 3 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 4 Lower TLC]: 4. model with 4 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 5 Lower TLC]: 5. model with 5 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 6 Lower TLC]: 6. model with 6 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 7 Lower TLC]: 7. model with 7 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Rel_dsch_WY",grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg","Rel_dsch_WY",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 8 Lower TLC]: 8. model with 8 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Chan_wid",grep("Rel_dsch_WY",grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg","Rel_dsch_WY","Chan_wid",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 9 Lower TLC]: 9. model with 9 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("macro.type",grep("Chan_wid",grep("Rel_dsch_WY",grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg","Rel_dsch_WY","Chan_wid","macro.type",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 10 Lower TLC]: 10. model with 10 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("new_part",grep("macro.type",grep("Chan_wid",grep("Rel_dsch_WY",grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg","Rel_dsch_WY","Chan_wid","macro.type","new_part",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type/new_part\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type/new_part & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# # ---------------------------------------------------------------------------------
		# # [Subset 11 Lower TLC]: 11. model with 11 variable (one variable)
		# # ---------------------------------------------------------------------------------
		# save.command <- ""
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Depth_Mean",grep("new_part",grep("macro.type",grep("Chan_wid",grep("Rel_dsch_WY",grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg","Rel_dsch_WY","Chan_wid","macro.type","new_part","Depth_Mean",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type/new_part/Depth_Mean\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type/new_part/Depth_Mean & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		# ---------------------------------------------------------------------------------
		# [Subset 12 Lower TLC]: 12. model with 12 variable (one variable)
		# ---------------------------------------------------------------------------------
		save.command <- ""
		no.tmp  <- length(c(X.var.num,X.var.cat))
		idx.tmp <- 0
		for (X.var.rm in grep("new_NFHAP",grep("Depth_Mean",grep("new_part",grep("macro.type",grep("Chan_wid",grep("Rel_dsch_WY",grep("Seg", grep("T_dist_up",grep("Season",grep("Stk_60_cnt",grep("GIS_RM",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		{
			idx.tmp <- idx.tmp + 1
			idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
			if(!(is.na(idx.var.rm)))
			{
				model.count  <- model.count + 1
				myData.Tmp   <- myData.Work[,c("Pal_cnt","GIS_RM","Stk_60_cnt","Season","T_dist_up","Seg","Rel_dsch_WY","Chan_wid","macro.type","new_part","Depth_Mean","new_NFHAP",X.var.rm)]
				# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
				...
				model.ID     <- X.var.rm
				model.string <- paste("Model",model.count," with ",X.var.rm," & GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type/new_part/Depth_Mean/new_NFHAP\n",sep=" ")
				model.no.var <- dim(myData.Tmp)[2] - 1
				model.rm.var <- paste("all but GIS_RM/Stk_60_cnt/Season/T_dist_up/Seg/Rel_dsch_WY/Chan_wid/macro.type/new_part/Depth_Mean/new_NFHAP & ",X.var.rm,sep=" ")
...
cat(paste("\n14_VariableSelection_Subset4_pscl_final.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n14_VariableSelection_Subset4_pscl_final.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [14_VariableSelection_Subset4_pscl_final.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [14_VariableSelection_Subset4_pscl_final.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
