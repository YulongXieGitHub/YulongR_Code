...
FL.stock.PDF <- paste(Path.Out,"3_Chk_April24_2013Data_stock_var.pdf",sep="/")	
...
for (var in names(myData))
{
	...
	{	
		...
		plot.all   <- histogram(myData.tmp,      freq=FALSE,nint=100, xlab=var,ylab="Count",type="count",main=paste("Distribution of ",var,"(with ",no.NA,      " missing values)",       sep=""))
		plot.upper <- histogram(myData.tmp.upper,freq=FALSE,nint=100, xlab=var,ylab="Count",type="count",main=paste("Distribution of ",var,"(with ",no.NA.upper," missing values)\nUpper",sep=""))
		plot.lower <- histogram(myData.tmp.lower,freq=FALSE,nint=100, xlab=var,ylab="Count",type="count",main=paste("Distribution of ",var,"(with ",no.NA.lower," missing values)\nLower",sep=""))
...
# 
FL.binary_cat.csv <- paste(Path.Out,"3_Chk_April24_2013Data_Binary_catVar.csv",sep="/")
