#
# 24_VariableSelection_Subset1_pscl_final_modified.R
#
...
Path.OUT <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/24_VariableSelection_final_modified"
...
FL.LOG    <- paste(Path.log,"24_VariableSelection_Subset1_pscl_final_modified.log",sep="/")	
...
FL.RESL.OUT <- paste(Path.OUT,"24_VariableSelection_Subset1_pscl_final_modified.csv",sep="/")
...
for (idx.subset in c(1))
{
	...
	{		
		...
		Y.var  <- "Pal_cnt"
		  ...
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_dn")																# 1 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_dn","Wet_wid","Grade_10_RM","Stk_24_cnt")												# 2 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_dn","Stk_12_cnt")															# 3 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_dn","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt")											# 4 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_dn","Stk_36_cnt","Chan_wid")													# 5 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","Chan_wid","Stk_24_cnt")																# 6 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_near","Stk_12_cnt","Stk_120_cnt")														# 7 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_near","GIS_RM","Depth_Mean")															# 8 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","GIS_RM","Stk_12_cnt","Stk_36_cnt","Stk_60_cnt","Stk_120_cnt","Depth_Mean")								# 9 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","GIS_RM","Stk_12_cnt","Stk_36_cnt","Stk_60_cnt","Stk_120_cnt","Season","new_lith")							# 10 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_near","Stk_12_cnt","Stk_36_cnt","Stk_60_cnt","Stk_120_cnt","VF_wid","Temp","new_lith","new_part")					# 11 variable
		  var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUA.calc","D_dist_up","D_dist_dn","D_dist_near","Sand_per","Comp_per","Clay_per","T_dist_up","T_dist_near","Stk_12_cnt","Stk_36_cnt","Stk_60_cnt","Stk_120_cnt","new_lith","new_part","GIS_RM","Temp","Depth_Mean", "Rel_dsch_AY")	# 12 variable
	...
	if(idx.subset == 1)	# PSCL Upper OT_TN
	{
		...
		# no.tmp  <- length(c(X.var.num,X.var.cat))
		# idx.tmp <- 0
		# for (X.var.rm in grep("Chan_wid",grep("Seg",grep("Grade_10_RM", grep("Stk_24_cnt", grep("T_dist_dn",grep("new_NFHAP",grep("Wet_wid",grep("new_meso",grep("macro.type",grep("SY",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		# {
		# 	idx.tmp <- idx.tmp + 1
		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
		# 	if(!(is.na(idx.var.rm)))
		# 	{
		# 		model.count  <- model.count + 1
		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","SY","macro.type","new_meso","Wet_wid","new_NFHAP","T_dist_dn","Stk_24_cnt","Grade_10_RM","Seg","Chan_wid",X.var.rm)]
		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
		# 		
		# 
		# 		# -----------------------------------------------------------------------------------------------------------------
		...
		# 		
		# 		model.ID     <- X.var.rm
		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & SY/macro.type/new_meso/Wet_wid/new_NFHAP/T_dist_dn/Stk_24_cnt/Grade_10_RM/Seg/Chan_wid\n",sep=" ")
		# 		model.no.var <- dim(myData.Tmp)[2] - 1
		# 		model.rm.var <- paste("all but SY/macro.type/new_meso/Wet_wid/new_NFHAP/T_dist_dn/Stk_24_cnt/Grade_10_RM/Seg/Chan_wid & ",X.var.rm,sep=" ")
		#
		# 		model.formula       <- summary(model.Tmp)$call
		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
		...
		no.tmp  <- length(c(X.var.num,X.var.cat))
		idx.tmp <- 0
		for (X.var.rm in grep("Braid",grep("Chan_wid",grep("Seg",grep("Grade_10_RM", grep("Stk_24_cnt", grep("T_dist_dn",grep("new_NFHAP",grep("Wet_wid",grep("new_meso",grep("macro.type",grep("SY",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
		{
			idx.tmp <- idx.tmp + 1
			idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
			if(!(is.na(idx.var.rm)))
			{
				model.count  <- model.count + 1
				myData.Tmp   <- myData.Work[,c("Pal_cnt","SY","macro.type","new_meso","Wet_wid","new_NFHAP","T_dist_dn","Stk_24_cnt","Grade_10_RM","Seg","Chan_wid","Braid",X.var.rm)]
				# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
				...
				model.ID     <- X.var.rm
				model.string <- paste("Model",model.count," with ",X.var.rm," & SY/macro.type/new_meso/Wet_wid/new_NFHAP/T_dist_dn/Stk_24_cnt/Grade_10_RM/Seg/Chan_wid/Braid\n",sep=" ")
				model.no.var <- dim(myData.Tmp)[2] - 1
				model.rm.var <- paste("all but SY/macro.type/new_meso/Wet_wid/new_NFHAP/T_dist_dn/Stk_24_cnt/Grade_10_RM/Seg/Chan_wid/Braid & ",X.var.rm,sep=" ")
		...
		# sort the output
		#
		o <- order(as.numeric(summary.out[,"no.var"]),as.numeric(summary.out[,"AIC"]))
		cat(paste("summary,",            sep=""),file=FL.OUT.Model,append=TRUE)
		write.table(data.frame(summary.out[o,]),file=FL.OUT.Model,row.names=TRUE,col.names=TRUE,sep=",",append=TRUE)		
...
cat(paste("\n24_VariableSelection_Subset1_pscl_final_modified.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n24_VariableSelection_Subset1_pscl_final_modified.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [24_VariableSelection_Subset1_pscl_final_modified.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [24_VariableSelection_Subset1_pscl_final_modified.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
