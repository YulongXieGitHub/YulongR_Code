#
# 24_VariableSelection_Subset6_final.R
#
# August 27, 2013
#
...
FL.LOG    <- paste(Path.log,"24_VariableSelection_Subset6_final.log",sep="/")	
...
FL.RESL.OUT <- paste(Path.OUT,"24_VariableSelection_Subset6_final.csv",sep="/")
...
for (idx.subset in c(6))
{
	...
	# subset 6: Logistic Upper [myData.Upper_Logistic]
		...
		Y.var  <- "binary"
		var.rm.fix <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUE","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type2","CPUA.calc","CPUE.calc","Comp_per","Sand_per","Clay_per","new_lith","new_part","gear.type1")
		var.rm     <- c("Gear","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","MicroClass","WaterVel","Fish_cnt","CPUE","CPUA","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type2","CPUA.calc","CPUE.calc","Comp_per","Sand_per","Clay_per","new_lith","new_part","gear.type1")
	...
	if(idx.subset == 6)	# Logistic Regression for Upper River
	{
		...
		# sort the output
		#
		o <- order(summary.out[,"no.var"],as.numeric(summary.out[,"AIC"]))
		cat(paste("summary,",            sep=""),file=FL.OUT.Model,append=TRUE)
...
cat(paste("\n24_VariableSelection_Subset6_final.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n24_VariableSelection_Subset6_final.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [24_VariableSelection_Subset6_final.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [24_VariableSelection_Subset6_final.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
