#
# 14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_other.R
#
...
Path.OUT <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/14_VariableSelection_Subset5_FINAL_2014March7_checl_meso_OTHER_lowerStream"
...
FL.LOG    <- paste(Path.log,"14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_other.log",sep="/")	
...
FL.RESL.OUT <- paste(Path.OUT,"14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_otherl.csv",sep="/")
...
for (idx.subset in c(5))
{
	...
	# subset 5: lower GN [myData.Lower_GN]
		...
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc")						 												# 1-6 variables
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","macro.type")   																# 7   variables
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc")   																		# 8   variables
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc")   																		# 9   variables
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc")   																		# 10   variables
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","Seg")  											# 11   variables
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","Sand_per","Comp_per","T_dist_up","Grade_10_RM","Seg")  					# 12   variables 
		  var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","Stk_12_cnt","Stk_24_cnt","Stk_36_cnt","Stk_120_cnt","Sand_per","Comp_per","Chan_wid","T_dist_up","VF_wid","Seg","MicroClass")  								# 13   variables 
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","GIS_RM","D_dist_up","Chan_wid","Braid","T_dist_up","T_dist_dn","T_dist_near","Stk_12_cnt","Stk_36_cnt","Stk_60_cnt","Rel_dsch_AY")  		# 14   variables 
		# var.rm     <- c("Gear","Season","D_dist_dn","D_dist_near","MA","Lith_1","Lith_2","Lith_desc","NFHAP","Tax_part_sz","Turb","Meso","WaterVel","Fish_cnt","CPUE","Stk_12_dist","Stk_24_dist","Stk_36_dist","Stk_60_dist","Stk_120_dist",                            "gear.type1","gear.type2","CPUE.calc","GIS_RM","D_dist_up","Chan_wid","Braid","T_dist_dn","Grade_10_RM","Clay_per","Stk_12_cnt","Stk_36_cnt","Stk_60_cnt","Rel_dsch_AY","new_part") 	# 15   variables 
...
#
# March 7, 2014: Chris asked to verify WHAT included in the OTHER group of MesoHabitat variable in both "Gillnet" and "Logistic" of Lower Stream
#                data actually used in the analysis
#
FL_subset5.OUT <- paste(Path.OUT,"2014_March7_lower_gillnet_actuallyUsed.csv",sep="/")

write.table(myData.Sub, file=FL_subset5.OUT,sep=",",row.names=FALSE,col.name=TRUE)

#
# March 7, 2014: data in exploratory analysis
#

Path.12 <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/12_Prep_Subset_Data_for_var_kept_Final"
FL.IN   <- paste(Path.12,"12_Prep_Subset_Data_for_var_kept_Final.Rdata",sep="/")
FL_subset5.OUT  <- paste(Path.OUT,"2014_March7_lower_gillnet_dataPreparartion.csv",sep="/")
load(FL.IN)
myData.Lower.Gillnet  <- subset(myData.All,MA=="Lower" & gear.type1 == "GN")
write.table(myData.Lower.Gillnet, file=FL_subset5.OUT,sep=",",row.names=FALSE,col.name=TRUE)
...
#	if(idx.subset == 5)	# PSCL Upper TLC
#	{
...
#		# no.tmp  <- length(c(X.var.num,X.var.cat))
#		# idx.tmp <- 0
#		# for (X.var.rm in grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE))
#		# {
#		# 	idx.tmp <- idx.tmp + 1
#		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		# 	if(!(is.na(idx.var.rm)))
#		# 	{
#		# 		model.count  <- model.count + 1
#		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid",X.var.rm)]
#		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		# 		
#		# 
#		# 		# -----------------------------------------------------------------------------------------------------------------
...
#		# 		
#		# 		model.ID     <- X.var.rm
#		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid\n",sep=" ")
#		# 		model.no.var <- dim(myData.Tmp)[2] - 1
#		# 		model.rm.var <- paste("all but Wet_wid & ",X.var.rm,sep=" ")
#		#
#		# 		model.formula       <- summary(model.Tmp)$call
#		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		# no.tmp  <- length(c(X.var.num,X.var.cat))
#		# idx.tmp <- 0
#		# for (X.var.rm in grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		# {
#		# 	idx.tmp <- idx.tmp + 1
#		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		# 	if(!(is.na(idx.var.rm)))
#		# 	{
#		# 		model.count  <- model.count + 1
#		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso",X.var.rm)]
#		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		# 		
#		# 
#		# 		# -----------------------------------------------------------------------------------------------------------------
...
#		# 		
#		# 		model.ID     <- X.var.rm
#		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso\n",sep=" ")
#		# 		model.no.var <- dim(myData.Tmp)[2] - 1
#		# 		model.rm.var <- paste("all but Wet_wid/new_meso & ",X.var.rm,sep=" ")
#		#
#		# 		model.formula       <- summary(model.Tmp)$call
#		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		# no.tmp  <- length(c(X.var.num,X.var.cat))
#		# idx.tmp <- 0
#		# for (X.var.rm in grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		# {
#		# 	idx.tmp <- idx.tmp + 1
#		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		# 	if(!(is.na(idx.var.rm)))
#		# 	{
#		# 		model.count  <- model.count + 1
#		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith",X.var.rm)]
#		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		# 		
#		# 
#		# 		# -----------------------------------------------------------------------------------------------------------------
...
#		# 		
#		# 		model.ID     <- X.var.rm
#		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith\n",sep=" ")
#		# 		model.no.var <- dim(myData.Tmp)[2] - 1
#		# 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith & ",X.var.rm,sep=" ")
#		#
#		# 		model.formula       <- summary(model.Tmp)$call
#		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		# no.tmp  <- length(c(X.var.num,X.var.cat))
#		# idx.tmp <- 0
#		# for (X.var.rm in grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		# {
#		# 	idx.tmp <- idx.tmp + 1
#		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		# 	if(!(is.na(idx.var.rm)))
#		# 	{
#		# 		model.count  <- model.count + 1
#		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY",X.var.rm)]
#		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		# 		
#		# 
#		# 		# -----------------------------------------------------------------------------------------------------------------
...
#		# 		
#		# 		model.ID     <- X.var.rm
#		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY\n",sep=" ")
#		# 		model.no.var <- dim(myData.Tmp)[2] - 1
#		# 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY & ",X.var.rm,sep=" ")
#		#
#		# 		model.formula       <- summary(model.Tmp)$call
#		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		# no.tmp  <- length(c(X.var.num,X.var.cat))
#		# idx.tmp <- 0
#		# for (X.var.rm in grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		# {
#		# 	idx.tmp <- idx.tmp + 1
#		# 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		# 	if(!(is.na(idx.var.rm)))
#		# 	{
#		# 		model.count  <- model.count + 1
#		# 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY",X.var.rm)]
#		# 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		# 		
#		# 
#		# 		# -----------------------------------------------------------------------------------------------------------------
...
#		# 		
#		# 		model.ID     <- X.var.rm
#		# 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY\n",sep=" ")
#		# 		model.no.var <- dim(myData.Tmp)[2] - 1
#		# 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY & ",X.var.rm,sep=" ")
#		#
#		# 		model.formula       <- summary(model.Tmp)$call
#		# 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		# 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  # no.tmp  <- length(c(X.var.num,X.var.cat))
#		  # idx.tmp <- 0
#		  # for (X.var.rm in grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  # {
#		  # 	idx.tmp <- idx.tmp + 1
#		  # 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  # 	if(!(is.na(idx.var.rm)))
#		  # 	{
#		  # 		model.count  <- model.count + 1
#		  # 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp",X.var.rm)]
#		  # 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  # 		
#		  # 
#		  # 		# -----------------------------------------------------------------------------------------------------------------
...
#		  # 		
#		  # 		model.ID     <- X.var.rm
#		  # 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp\n",sep=" ")
#		  # 		model.no.var <- dim(myData.Tmp)[2] - 1
#		  # 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp & ",X.var.rm,sep=" ")
#		  #
#		  # 		model.formula       <- summary(model.Tmp)$call
#		  # 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  # 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  # no.tmp  <- length(c(X.var.num,X.var.cat))
#		  # idx.tmp <- 0
#		  # for (X.var.rm in grep("new_NFHAP", grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  # {
#		  # 	idx.tmp <- idx.tmp + 1
#		  # 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  # 	if(!(is.na(idx.var.rm)))
#		  # 	{
#		  # 		model.count  <- model.count + 1
#		  # 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp","new_NFHAP",X.var.rm)]
#		  # 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  # 		
#		  # 
#		  # 		# -----------------------------------------------------------------------------------------------------------------
...
#		  # 		
#		  # 		model.ID     <- X.var.rm
#		  # 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP\n",sep=" ")
#		  # 		model.no.var <- dim(myData.Tmp)[2] - 1
#		  # 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP & ",X.var.rm,sep=" ")
#		  #
#		  # 		model.formula       <- summary(model.Tmp)$call
#		  # 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  # 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  # no.tmp  <- length(c(X.var.num,X.var.cat))
#		  # idx.tmp <- 0
#		  # for (X.var.rm in grep("Rel_dsch_AY", grep("new_NFHAP", grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  # {
#		  # 	idx.tmp <- idx.tmp + 1
#		  # 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  # 	if(!(is.na(idx.var.rm)))
#		  # 	{
#		  # 		model.count  <- model.count + 1
#		  # 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp","new_NFHAP","Rel_dsch_AY",X.var.rm)]
#		  # 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  # 		
#		  # 
#		  # 		# -----------------------------------------------------------------------------------------------------------------
...
#		  # 		
#		  # 		model.ID     <- X.var.rm
#		  # 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/Rel_dsch_AY\n",sep=" ")
#		  # 		model.no.var <- dim(myData.Tmp)[2] - 1
#		  # 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP/Rel_dsch_AY & ",X.var.rm,sep=" ")
#		  #
#		  # 		model.formula       <- summary(model.Tmp)$call
#		  # 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  # 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  # no.tmp  <- length(c(X.var.num,X.var.cat))
#		  # idx.tmp <- 0
#		  # for (X.var.rm in grep("Depth_Mean",grep("Rel_dsch_AY", grep("new_NFHAP", grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  # {
#		  # 	idx.tmp <- idx.tmp + 1
#		  # 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  # 	if(!(is.na(idx.var.rm)))
#		  # 	{
#		  # 		model.count  <- model.count + 1
#		  # 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp","new_NFHAP","Rel_dsch_AY","Depth_Mean",X.var.rm)]
#		  # 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  # 		
#		  # 
#		  # 		# -----------------------------------------------------------------------------------------------------------------
...
#		  # 		
#		  # 		model.ID     <- X.var.rm
#		  # 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/Rel_dsch_AY/Depth_Mean\n",sep=" ")
#		  # 		model.no.var <- dim(myData.Tmp)[2] - 1
#		  # 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP/Rel_dsch_AY/Depth_Mean & ",X.var.rm,sep=" ")
#		  #
#		  # 		model.formula       <- summary(model.Tmp)$call
#		  # 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  # 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  # no.tmp  <- length(c(X.var.num,X.var.cat))
#		  # idx.tmp <- 0
#		  # for (X.var.rm in grep("Stk_60_cnt",grep("Depth_Mean",grep("Rel_dsch_AY", grep("new_NFHAP", grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  # {
#		  # 	idx.tmp <- idx.tmp + 1
#		  # 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  # 	if(!(is.na(idx.var.rm)))
#		  # 	{
#		  # 		model.count  <- model.count + 1
#		  # 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp","new_NFHAP","Rel_dsch_AY","Depth_Mean","Stk_60_cnt",X.var.rm)]
#		  # 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  # 		
#		  # 
#		  # 		# -----------------------------------------------------------------------------------------------------------------
...
#		  # 		
#		  # 		model.ID     <- X.var.rm
#		  # 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/Rel_dsch_AY/Depth_Mean/Stk_60_cnt\n",sep=" ")
#		  # 		model.no.var <- dim(myData.Tmp)[2] - 1
#		  # 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP/Rel_dsch_AY/Depth_Mean/Stk_60_cnt & ",X.var.rm,sep=" ")
#		  #
#		  # 		model.formula       <- summary(model.Tmp)$call
#		  # 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  # 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  # no.tmp  <- length(c(X.var.num,X.var.cat))
#		  # idx.tmp <- 0
#		  # for (X.var.rm in grep("Clay_per",grep("Stk_60_cnt",grep("Depth_Mean",grep("Rel_dsch_AY", grep("new_NFHAP", grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  # {
#		  # 	idx.tmp <- idx.tmp + 1
#		  # 	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  # 	if(!(is.na(idx.var.rm)))
#		  # 	{
#		  # 		model.count  <- model.count + 1
#		  # 		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp","new_NFHAP","Rel_dsch_AY","Depth_Mean","Stk_60_cnt","Clay_per",X.var.rm)]
#		  # 		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  # 		
#		  # 
#		  # 		# -----------------------------------------------------------------------------------------------------------------
...
#		  # 		
#		  # 		model.ID     <- X.var.rm
#		  # 		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/Rel_dsch_AY/Depth_Mean/Stk_60_cnt/Clay_per\n",sep=" ")
#		  # 		model.no.var <- dim(myData.Tmp)[2] - 1
#		  # 		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP/Rel_dsch_AY/Depth_Mean/Stk_60_cnt/Clay_per & ",X.var.rm,sep=" ")
#		  #
#		  # 		model.formula       <- summary(model.Tmp)$call
#		  # 		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  # 		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#		  no.tmp  <- length(c(X.var.num,X.var.cat))
#		  idx.tmp <- 0
#		  for (X.var.rm in grep("macro.type",grep("Clay_per",grep("Stk_60_cnt",grep("Depth_Mean",grep("Rel_dsch_AY", grep("new_NFHAP", grep("Temp",grep("SY",grep("Rel_dsch_WY",grep("new_lith",grep("new_meso",grep("Wet_wid",c(X.var.num,X.var.cat),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE),value=TRUE,invert=TRUE))
#		  {
#		  	idx.tmp <- idx.tmp + 1
#		  	idx.var.rm <- match(X.var.rm,names(myData.Work))				# the index of the variable to be removed in the data frame
#		  	if(!(is.na(idx.var.rm)))
#		  	{
#		  		model.count  <- model.count + 1
#		  		myData.Tmp   <- myData.Work[,c("Pal_cnt","Wet_wid","new_meso","new_lith","Rel_dsch_WY","SY","Temp","new_NFHAP","Rel_dsch_AY","Depth_Mean","Stk_60_cnt","Clay_per","macro.type",X.var.rm)]
#		  		# model.Tmp    <- glm(binary ~ .,data=myData.Tmp,family=binomial("logit"))
#		  		
#		  
#		  		# -----------------------------------------------------------------------------------------------------------------
...
#		  		
#		  		model.ID     <- X.var.rm
#		  		model.string <- paste("Model",model.count," with ",X.var.rm," & Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/Rel_dsch_AY/Depth_Mean/Stk_60_cnt/Clay_per/macro.type\n",sep=" ")
#		  		model.no.var <- dim(myData.Tmp)[2] - 1
#		  		model.rm.var <- paste("all but Wet_wid/new_meso/new_lith/Rel_dsch_WY/SY/Temp/new_NFHAP/Rel_dsch_AY/Depth_Mean/Stk_60_cnt/Clay_per/macro.type & ",X.var.rm,sep=" ")
#		  
#		  		model.formula       <- summary(model.Tmp)$call
#		  		model.coef.count    <- as.data.frame(summary(model.Tmp)$coef$count)
#		  		model.coef.zero     <- as.data.frame(summary(model.Tmp)$coef$zero)
...
#Diff.time
#
#cat(paste("\n14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_other.R is finished successfully at ",End.time,"!\n",sep=" "))
#cat(paste("\n14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_other.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)
#
#cat(paste("\nProcessing time for [14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_other.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
#cat(paste("\nProcessing time for [14_VariableSelection_Subset5_pscl_FINAL_2014March7_check_lowerStream_meso_other.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
#
##
