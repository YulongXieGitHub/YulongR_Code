...
Path.Out     <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/11_Chk_June21_2013Data"
...
FL.LOG       <- paste(Path.log,"11_Chk_June21_2013Data.log",               sep="/")	
FL.Data.OUT  <- paste(Path.Out,"MoRiver_Variables_2013May31_revisedOn_2013June21_YLX_app.csv",sep="/")
FL.SUM.cat   <- paste(Path.Out,"11_Chk_June21_2013Data_categoricalSum.csv",sep="/")
FL.SUM.num   <- paste(Path.Out,"11_Chk_June21_2013Data_numericSum.csv",    sep="/")
FL.Summary   <- paste(Path.Out,"11_Chk_June21_2013Data_summary.csv",       sep="/")
FL.missing   <- paste(Path.Out,"11_Chk_June21_2013Data_missing.csv",       sep="/")
...
# FL_Total_cnt_vs_Pal_cnt.sum <- paste(Path.Out,"11_Chk_June21_2013Data_Gear_CPUE_CPUA.csv",sep="/")	
#
# Total Fish Catch vs Pallid Fish Catch
#
FL_Total_cnt_vs_Pal_cnt.pdf <- paste(Path.Out,"11_Chk_June21_2013Data_Tot_Cnt_vs_Pal_Cnt.pdf",sep="/")	
...
# FL_CPUE_CPUA.sum <- paste(Path.Out,"11_Chk_June21_2013Data_Gear_CPUE_CPUA.csv",sep="/")	
# FL_CPUE_CPUA.pdf <- paste(Path.Out,"11_Chk_June21_2013Data_Gear_CPUE_CPUA.pdf",sep="/")	
# *********************************************************************************************************************
#
...
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.stock.PDF <- paste(Path.Out,"11_Chk_June21_2013Data_stock_var.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.microHabitat <- paste(Path.Out,"11_Chk_June21_2013Data_microHabitat.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
FL.sandClay <- paste(Path.Out,"11_Chk_June21_2013Data_sandClay.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 2a. check each individual variable: [11_Chk_June21_2013Data_indVar.pdf] and [11_Chk_June21_2013Data_num.sum]
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.indVar.PDF <- paste(Path.Out,"11_Chk_June21_2013Data_indVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 2b. check the correlation between small group of variables: [11_Chk_June21_2013Data_indVar.pdf]
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# 3. check correlation between numeric covariates: [11_Chk_June21_2013Data_Correlation.pdf]
# -------------------------------------------------------------------------------------------------
FL.Correlation.PDF  <- paste(Path.Out,"11_Chk_June21_2013Data_Correlation.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 4. count summary: FL.Summary == [11_Chk_June21_2013Data_summary.csv]
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# 6. check correlation of continusous variables vs the [count] of Pallid Sturgeon: [11_Chk_June21_2013Data_Count_numVar.pdf]
# -------------------------------------------------------------------------------------------------
FL.Count_num.PDF  <- paste(Path.Out,"11_Chk_June21_2013Data_Count_numVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 7. check the correlation of discrete variables vs the [count] of Pallid Sturgeon: FL.Summary == [11_Chk_June21_2013Data_summary.csv]
# -------------------------------------------------------------------------------------------------
# FL.Count_cat.PDF  <- paste(Path.Out,"11_Chk_June21_2013Data_Count_catVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 8. check correlation of continusous variables vs the [count] of Pallid Sturgeon: 11_Chk_June21_2013Data_Binary_numVar.pdf; 	FL.Summary == [11_Chk_June21_2013Data_summary.csv]
# -------------------------------------------------------------------------------------------------
FL.binary_num.PDF  <- paste(Path.Out,"11_Chk_June21_2013Data_Binary_numVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# FL.binary_cat.PDF  <- paste(Path.Out,"11_Chk_June21_2013Data_Binary_catVar.pdf",sep="/")	
...
# 
FL.binary_cat.csv <- paste(Path.Out,"11_Chk_June21_2013Data_Binary_catVar.csv",sep="/")
