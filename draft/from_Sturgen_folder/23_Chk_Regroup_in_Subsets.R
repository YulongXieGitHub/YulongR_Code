...
Path.OUT <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/23_Chk_Regroup_in_Subsets"
...
FL.LOG    <- paste(Path.log,"23_Chk_Regroup_in_Subsets.log",sep="/")	
...
cat(paste("\n23_Chk_Regroup_in_Subsets.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n23_Chk_Regroup_in_Subsets.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [23_Chk_Regroup_in_Subsets.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [23_Chk_Regroup_in_Subsets.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
