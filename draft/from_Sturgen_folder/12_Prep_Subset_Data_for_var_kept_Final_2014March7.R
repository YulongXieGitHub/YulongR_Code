#
# 12_Prep_Subset_Data_for_var_kept_Final_2014March7.R
#
# October 2, 2013
#
...
Path.Out     <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/12_Prep_Subset_Data_for_var_kept_Final_2014March7"
...
FL.LOG       <- paste(Path.log,"12_Prep_Subset_Data_for_var_kept_Final_2014March7.log",                sep="/")	
FL.Data.OBJ  <- paste(Path.Out,"12_Prep_Subset_Data_for_var_kept_Final_2014March7.Rdata",              sep="/")
...
cat(paste("\n12_Prep_Subset_Data_for_var_kept_Final_2014March7.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n12_Prep_Subset_Data_for_var_kept_Final_2014March7.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [12_Prep_Subset_Data_for_var_kept_Final_2014March7.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [12_Prep_Subset_Data_for_var_kept_Final_2014March7.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
