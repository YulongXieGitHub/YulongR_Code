...
#
# 12b_check_CPUA_of_CategoricalVariable.R
#
# August 14, 2013
#
...
Path.OUT <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/12b_check_CPUA_of_CategoricalVariable"
...
FL.LOG    <- paste(Path.log,"12b_check_CPUA_of_CategoricalVariable.log",sep="/")	
