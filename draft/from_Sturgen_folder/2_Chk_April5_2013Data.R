#
# 2_Chk_April5_2013Data.R
#
# Chris Vernon compiled a combined PAP and GIS data set.
#
# eliminate all stuff
rm(list = ls(all = TRUE))
...
Path.Out     <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/2_Chk_April5_2013Data"
...
FL.Data.IN   <- paste(Path.Data.IN,"MoRiver_Variables_2013Apr4_YLX.csv",sep="/")
FL.LOG       <- paste(Path.log,"2_Chk_April5_2013Data.log",sep="/")	
FL.SUM.cat   <- paste(Path.Out,"2_Chk_April5_2013Data_categoricalSum.csv",sep="/")
FL.SUM.num   <- paste(Path.Out,"2_Chk_April5_2013Data_numericSum.csv",sep="/")
FL.Summary   <- paste(Path.Out,"2_Chk_April5_2013Data_summary.csv",sep="/")
FL.missing   <- paste(Path.Out,"2_Chk_April5_2013Data_missing.csv",sep="/")
...
# read April 8, 2013 data 
row.titles  <- c("ID",     "SY",     "FieldOffice","Project","UniqueID","Gear",  "Season","Bend",   "BendRN","BendRiverMile","Near_NHD2rm_FID","Near_NHD2RM_dist_m","NHD2_RM","X1960BendID","RM1960_RM","UpDamDist","UpDamNm","DnDamDist","DnDamNm","Ch_W_Full","Ch_W_NoIsl","Braiding","UpTrib","UpTribDist","DnTrib","DTribDist","Reach", "Mean_z", "Max_z",  "Min_z",  "Grade10RM","GradeBend","Rocktype1","Rocktype2","Lithology","NFHAP_Scr","MedFlow","MeanFlow","taxorder","taxpartsiz","comppct_r","sandtotal_r","claytotal_r","frag3to10_r","VF_width","Segment","nPage",  "TotalPages","SetDate",  "Replicate","ReplicateRN","SubSample","SubSamplePass","SubSampleN","Biologist","Recorder", "CheckBy",  "Temp",   "Turbidity","Conductivity","DO",     "Distance","Width",  "NetRiverMile","StructureNumber","USGS",  "RiverStage","Discharge","U1",       "U2",       "U3",       "U4",       "U5",       "U6",       "U7",       "Macro", "MacroSW","Meso",  "MesoSW","Micro", "StartTime","StopTime", "DecimalTimeDifference","StartLatitude","StopLatitude","StartLongitude","StopLongitude","Depth1", "Depth2", "Depth3", "Velocity02or06_1","Velocity02or06_2","Velocity02or06_3","Velocity08_1","Velocity08_2","Velocity08_3","VelocityBot1","VelocityBot2","VelocityBot3","WaterVel","HabitatRN","Cobble", "silt",   "Sand",   "Gravel", "Organic","QC",       "Comments", "MappingBox","Total_Fish_Count","Pallid_Only_Count","CPUE",   "CPU_Area","Alt_Pallid_Only_Count","Alt_CPUE","Alt_CPU_Area","gear.type1","gear.type2","macro.type")
colClasses  <- c("integer","integer","factor",     "integer","integer", "factor","factor","integer","factor","numeric",      "integer",        "numeric",           "numeric","integer",    "numeric",  "numeric",  "factor", "numeric",  "factor", "numeric",  "numeric",   "integer", "factor","numeric",   "factor","numeric",  "factor","numeric","numeric","numeric","numeric",  "numeric",  "factor",   "factor",   "factor",   "factor",   "numeric","numeric", "factor",  "factor",    "numeric",  "numeric",    "numeric",    "numeric",    "numeric", "integer","integer","integer",   "factor",   "logic",    "logic",      "integer",  "integer",      "character", "character","character","character","numeric","numeric",  "numeric",     "numeric","numeric", "numeric","numeric",     "factor",         "factor","numeric",   "numeric",  "character","character","character","character","character","character","character","factor","factor", "factor","factor","factor","character","character","numeric",              "numeric",      "numeric",     "numeric",       "numeric",      "numeric","numeric","numeric","numeric",         "numeric",         "numeric",         "numeric",     "numeric",     "numeric",     "numeric",     "numeric",     "numeric",     "numeric", "character","numeric","numeric","numeric","numeric","numeric","character","character","character", "integer",         "inetger",          "numeric","numeric", "integer",              "integer", "numeric",     "factor",    "factor",    "factor")
used.4.plot <- c( FALSE,    TRUE,     FALSE,        FALSE,    FALSE,     TRUE,    TRUE,    TRUE,     FALSE,   TRUE,           FALSE,            FALSE,               FALSE,    FALSE,        TRUE,       TRUE,       FALSE,    FALSE,      FALSE,    TRUE,       TRUE,        TRUE,      FALSE,   TRUE,        FALSE,   TRUE,       TRUE,    TRUE,     TRUE,     TRUE,     TRUE,       TRUE,       TRUE,       TRUE,       TRUE,       TRUE,       TRUE,     TRUE,      TRUE,      TRUE,        TRUE,       TRUE,         TRUE,         TRUE,         TRUE,      TRUE,     FALSE,    FALSE,       FALSE,      FALSE,      FALSE,        FALSE,      FALSE,          FALSE,       FALSE,      FALSE,      FALSE,      TRUE,     FALSE,      FALSE,         FALSE,    TRUE,      FALSE,    FALSE,         FALSE,            FALSE,   FALSE,       FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      TRUE,    FALSE,    TRUE,    FALSE,   TRUE,    FALSE,      FALSE,      FALSE,                  FALSE,          FALSE,         FALSE,           FALSE,          TRUE,     TRUE,     TRUE,     FALSE,             FALSE,             FALSE,             FALSE,         FALSE,         FALSE,         FALSE,         FALSE,         FALSE,         TRUE,      FALSE,      FALSE,    FALSE,    FALSE,    FALSE,    FALSE,    FALSE,      FALSE,      FALSE,       TRUE,              TRUE,               TRUE,     TRUE,      FALSE,                  FALSE,     FALSE,         TRUE,        TRUE,        TRUE)
used.4.anal <- c( FALSE,    TRUE,     FALSE,        FALSE,    FALSE,     FALSE,   TRUE,    FALSE,    FALSE,   FALSE,          FALSE,            FALSE,               FALSE,    FALSE,        FALSE,      TRUE,       FALSE,    FALSE,      FALSE,    TRUE,       FALSE,       TRUE,      FALSE,   TRUE,        FALSE,   TRUE,       TRUE,    FALSE,    FALSE,    FALSE,    TRUE,       FALSE,      TRUE,       FALSE,      FALSE,      TRUE,       FALSE,    FALSE,     FALSE,     TRUE,        TRUE,       TRUE,         TRUE,         FALSE,        TRUE,      TRUE,     FALSE,    FALSE,       FALSE,      FALSE,      FALSE,        FALSE,      FALSE,          FALSE,       FALSE,      FALSE,      FALSE,      TRUE,     TRUE,       FALSE,         FALSE,    FALSE,     FALSE,    FALSE,         FALSE,            FALSE,   FALSE,       FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      FALSE,      TRUE,    FALSE,    FALSE,   FALSE,   FALSE,   FALSE,      FALSE,      FALSE,                  FALSE,          FALSE,         FALSE,           FALSE,          FALSE,    FALSE,    FALSE,    FALSE,             FALSE,             FALSE,             FALSE,         FALSE,         FALSE,         FALSE,         FALSE,         FALSE,         TRUE,      FALSE,      FALSE,    FALSE,    FALSE,    FALSE,    FALSE,    FALSE,      FALSE,      FALSE,       TRUE,              TRUE,               TRUE,     TRUE,      FALSE,                  FALSE,     FALSE,         TRUE,        TRUE,        TRUE)
...
# -------------------------------------------------------------------------------------------------
# 2a. check each individual variable: [2_Chk_April5_2013Data_indVar.pdf] and [2_Chk_April5_2013Data_num.sum]
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.indVar.PDF <- paste(Path.Out,"2_Chk_April5_2013Data_indVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 2b. check the correlation between small group of variables: [2_Chk_April5_2013Data_indVar.pdf]
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# 3. check correlation between numeric covariates: [2_Chk_April5_2013Data_Correlation.pdf]
# -------------------------------------------------------------------------------------------------
FL.Correlation.PDF  <- paste(Path.Out,"2_Chk_April5_2013Data_Correlation.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 4. count summary: FL.Summary == [2_Chk_April5_2013Data_summary.csv]
# -------------------------------------------------------------------------------------------------
myData.sub <- melt(myData,id.var=c("SY","Reach","Season","Bend","Macro","Meso","Segment","Gear","gear.type1","gear.type2","macro.type","Rocktype1","taxpartsiz"),measure.var="Pallid_Only_Count")
...
y.vars.cat <- "binary"
x.vars.cat <- c("Gear",  "Season","Bend",  "Reach", "Rocktype1","Rocktype2","Lithology","NFHAP_Scr","taxorder","taxpartsiz","Segment","gear.type1","gear.type2","macro.type")
...
# -------------------------------------------------------------------------------------------------
# 6. check correlation of continusous variables vs the [count] of Pallid Sturgeon: [2_Chk_April5_2013Data_Count_numVar.pdf]
# -------------------------------------------------------------------------------------------------
FL.Count_num.PDF  <- paste(Path.Out,"2_Chk_April5_2013Data_Count_numVar.pdf",sep="/")	
...
{
	# all data
	command.string <- paste("plot.obj1 <- xyplot(",y.vars.num," ~ ",var.num,", data = myData.work,xlab=\"",var.num,"\",ylab=\"",y.vars.num,"\",main=paste(\"(All) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),type=\"p\",pch=16,col=\"red\")",sep="")
	eval(parse(text=command.string))

	command.string <- paste("plot.obj2 <- bwplot(",var.num," ~ as.factor(",y.vars.num,"), data = myData.work,xlab=\"",y.vars.num,"\",ylab=\"",var.num,"\",main=paste(\"(All) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"red\")",sep="")
	eval(parse(text=command.string))

	# upper stream
	command.string <- paste("plot.obj3 <- xyplot(",y.vars.num," ~ ",var.num,", data = myData.work[myData.work[,\"Reach\"]==\"Upper\",],xlab=\"",var.num,"\",ylab=\"",y.vars.num,"\",main=paste(\"(Upper) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),type=\"p\",pch=16,col=\"blue\")",sep="")
	eval(parse(text=command.string))

	command.string <- paste("plot.obj4 <- bwplot(",var.num," ~ as.factor(",y.vars.num,"), data = myData.work[myData.work[,\"Reach\"]==\"Upper\",],xlab=\"",y.vars.num,"\",ylab=\"",var.num,"\",main=paste(\"(Upper) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"blue\")",sep="")
	eval(parse(text=command.string))
	
	# lower stream
	command.string <- paste("plot.obj5 <- xyplot(",y.vars.num," ~ ",var.num,", data = myData.work[myData.work[,\"Reach\"]==\"Lower\",],xlab=\"",var.num,"\",ylab=\"",y.vars.num,"\",main=paste(\"(Lower) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),type=\"p\",pch=16,col=\"green\")",sep="")
	eval(parse(text=command.string))

	command.string <- paste("plot.obj6 <- bwplot(",var.num," ~ as.factor(",y.vars.num,"), data = myData.work[myData.work[,\"Reach\"]==\"Lower\",],xlab=\"",y.vars.num,"\",ylab=\"",var.num,"\",main=paste(\"(Lower) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"green\")",sep="")
	eval(parse(text=command.string))
	...
	command.string <- paste("plot.obj <- xyplot(",y.vars.num," ~ ",var.num," | Segment, data = myData.work,xlab=\"",var.num,"\",ylab=\"",y.vars.num,"\",main=paste(\"(All) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),type=\"p\",pch=16,col=\"red\")",sep="")
	eval(parse(text=command.string))
	plot(plot.obj)

	# Segment-wise: boxplot plots
	command.string <- paste("plot.obj <- bwplot(",var.num," ~ as.factor(",y.vars.num,") | Segment, data = myData.work,xlab=\"",y.vars.num,"\",ylab=\"",var.num,"\",main=paste(\"(All) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"red\")",sep="")
	eval(parse(text=command.string))
	plot(plot.obj)
	
	# Macro-wise: scatter plots
	command.string <- paste("plot.obj <- xyplot(",y.vars.num," ~ ",var.num," | macro.type, data = myData.work,xlab=\"",var.num,"\",ylab=\"",y.vars.num,"\",main=paste(\"(All) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),type=\"p\",pch=16,col=\"blue\")",sep="")
	eval(parse(text=command.string))
	plot(plot.obj)

	# Macro-wise: boxplot plots
	command.string <- paste("plot.obj <- bwplot(",var.num," ~ as.factor(",y.vars.num,") | macro.type, data = myData.work,xlab=\"",y.vars.num,"\",ylab=\"",var.num,"\",main=paste(\"(All) \",\"",y.vars.num,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"blue\")",sep="")
	eval(parse(text=command.string))
	plot(plot.obj)
...
# -------------------------------------------------------------------------------------------------
# 7. check the correlation of discrete variables vs the [count] of Pallid Sturgeon: FL.Summary == [2_Chk_April5_2013Data_summary.csv]
# -------------------------------------------------------------------------------------------------
# FL.Count_cat.PDF  <- paste(Path.Out,"2_Chk_April5_2013Data_Count_catVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 8. check correlation of continusous variables vs the [count] of Pallid Sturgeon: 2_Chk_April5_2013Data_Binary_numVar.pdf; 	FL.Summary == [2_Chk_April5_2013Data_summary.csv]
# -------------------------------------------------------------------------------------------------
FL.binary_num.PDF  <- paste(Path.Out,"2_Chk_April5_2013Data_Binary_numVar.pdf",sep="/")	
...
{
	# all data
	command.string <- paste("plot.obj1 <- bwplot(",var.num," ~ as.factor(",y.vars.cat,"), data = myData.work,xlab=\"",y.vars.cat,"\",ylab=\"",var.num,"\",main=paste(\"(All) \",\"",y.vars.cat,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"red\",scale=list(y=\"free\"))",sep="")
	eval(parse(text=command.string))

	# upper stream
	command.string <- paste("plot.obj2 <- bwplot(",var.num," ~ as.factor(",y.vars.cat,"), data = myData.work[myData.work[,\"Reach\"]==\"Upper\",],xlab=\"",y.vars.cat,"\",ylab=\"",var.num,"\",main=paste(\"(Upper) \",\"",y.vars.cat,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"blue\",scale=list(y=\"free\"))",sep="")
	eval(parse(text=command.string))
	
	# lower stream
	command.string <- paste("plot.obj3 <- bwplot(",var.num," ~ as.factor(",y.vars.cat,"), data = myData.work[myData.work[,\"Reach\"]==\"Lower\",],xlab=\"",y.vars.cat,"\",ylab=\"",var.num,"\",main=paste(\"(Lower) \",\"",y.vars.cat,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"green\",scale=list(y=\"free\"))",sep="")
	eval(parse(text=command.string))
	...
	# Segment-wise: boxplot plots
	command.string <- paste("plot.obj <- bwplot(",var.num," ~ as.factor(",y.vars.cat,") | Segment, data = myData.work,xlab=\"",y.vars.cat,"\",ylab=\"",var.num,"\",main=paste(\"(All) \",\"",y.vars.cat,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"red\",scale=list(y=\"free\"))",sep="")
	eval(parse(text=command.string))
	plot(plot.obj)
	
	# Macro-wise: boxplot plots
	command.string <- paste("plot.obj <- bwplot(",var.num," ~ as.factor(",y.vars.cat,") | macro.type, data = myData.work,xlab=\"",y.vars.cat,"\",ylab=\"",var.num,"\",main=paste(\"(All) \",\"",y.vars.cat,"\",\" vs \",\"",var.num,"\",sep=\"\"),col=\"blue\",scale=list(y=\"free\"))",sep="")
	eval(parse(text=command.string))
	plot(plot.obj)
...
# -------------------------------------------------------------------------------------------------
# FL.binary_cat.PDF  <- paste(Path.Out,"2_Chk_April5_2013Data_Binary_catVar.pdf",sep="/")	
