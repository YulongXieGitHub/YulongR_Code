...
# Path.Out     <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/7_prepare_TLC_data"
...
# 
# FL.LOG       <- paste(Path.log,"7_prepare_TLC_data.log",sep="/")	
# FL.SUM.cat   <- paste(Path.Out,"7_prepare_TLC_data_categoricalSum.csv",sep="/")
# FL.SUM.num   <- paste(Path.Out,"7_prepare_TLC_data_numericSum.csv",sep="/")
# FL.Summary   <- paste(Path.Out,"7_prepare_TLC_data_summary.csv",sep="/")
# FL.missing   <- paste(Path.Out,"7_prepare_TLC_data_missing.csv",sep="/")
...
FL.RESL.OUT <- paste(Path.Out,"7_prepare_TLC_data.csv",sep="/")
FL.LOG      <- paste(Path.log,"7_prepare_TLC_data.log",sep="/")	
FL.PDF      <- paste(Path.Out,"7_prepare_TLC_data.pdf",sep="/")	
FL.SUM.cat  <- paste(Path.Out,"7_prepare_TLC_data_cat.sum",sep="/")
FL.SUM.num  <- paste(Path.Out,"7_prepare_TLC_data_num.sum",sep="/")
...
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.stock.PDF <- paste(Path.Out,"7_prepare_TLC_data_stock_dis.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.microHabitat <- paste(Path.Out,"7_prepare_TLC_data_microHabitat.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
FL.sandClay <- paste(Path.Out,"7_prepare_TLC_data_sandClay.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 2a. check each individual variable: [7_prepare_TLC_data_indVar.pdf] and [7_prepare_TLC_data_num.sum]
# -------------------------------------------------------------------------------------------------
# open pdf file for outputting plots
FL.indVar.PDF <- paste(Path.Out,"7_prepare_TLC_data_indVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 2b. check the correlation between small group of variables: [7_prepare_TLC_data_indVar.pdf]
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# 3. check correlation between numeric covariates: [7_prepare_TLC_data_Correlation.pdf]
# -------------------------------------------------------------------------------------------------
FL.Correlation.PDF  <- paste(Path.Out,"7_prepare_TLC_data_Correlation.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 4. count summary: FL.Summary == [7_prepare_TLC_data_summary.csv]
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# 6. check correlation of continusous variables vs the [count] of Pallid Sturgeon: [7_prepare_TLC_data_Count_numVar.pdf]
# -------------------------------------------------------------------------------------------------
FL.Count_num.PDF  <- paste(Path.Out,"7_prepare_TLC_data_Count_numVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 7. check the correlation of discrete variables vs the [count] of Pallid Sturgeon: FL.Summary == [7_prepare_TLC_data_summary.csv]
# -------------------------------------------------------------------------------------------------
# FL.Count_cat.PDF  <- paste(Path.Out,"7_prepare_TLC_data_Count_catVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# 8. check correlation of continusous variables vs the [count] of Pallid Sturgeon: 7_prepare_TLC_data_Binary_numVar.pdf; 	FL.Summary == [7_prepare_TLC_data_summary.csv]
# -------------------------------------------------------------------------------------------------
FL.binary_num.PDF  <- paste(Path.Out,"7_prepare_TLC_data_Binary_numVar.pdf",sep="/")	
...
# -------------------------------------------------------------------------------------------------
# FL.binary_cat.PDF  <- paste(Path.Out,"7_prepare_TLC_data_Binary_catVar.pdf",sep="/")	
