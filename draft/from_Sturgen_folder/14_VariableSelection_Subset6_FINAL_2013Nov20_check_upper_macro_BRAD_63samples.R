#
# 14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.R
#
...
Path.OUT <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples"
...
FL.LOG    <- paste(Path.log,"14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.log",sep="/")	
...
FL.RESL.OUT <- paste(Path.OUT,"14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.csv",sep="/")
...
#
# Nov 21, 2013: output the 63 (out of 8378) upper macro type == "BRAD" data actually used for analysis
#
FL.OUT <- paste(Path.OUT,"2013_Nov21_upper_BRAD_63samples.csv",sep="/")
myData.Upper.BRAD <- subset(myData.Sub,macro.type=="BRAD")
write.table(myData.Upper.BRAD,file=FL.OUT,sep=",",row.names=FALSE,col.name=TRUE)

#
# Nov 21, 2013: output the total 67 (out of 8742) upper macro type == "BRAD"
#
...
FL.OUT  <- paste(Path.OUT,"2013_Nov21_upper_BRAD_67samples.csv",sep="/")
load(FL.IN)
myData.Upper      <- subset(myData.All,MA=="Upper")
myData.Upper.BRAD <- subset(myData.Upper,macro.type=="BRAD")
write.table(myData.Upper.BRAD,file=FL.OUT,sep=",",row.names=FALSE,col.name=TRUE)
...
# Diff.time
# 
# cat(paste("\n14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.R is finished successfully at ",End.time,"!\n",sep=" "))
# cat(paste("\n14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)
# 
# cat(paste("\nProcessing time for [14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
# cat(paste("\nProcessing time for [14_VariableSelection_Subset6_FINAL_2013Nov20_check_upper_macro_BRAD_63samples.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
# 
# #
