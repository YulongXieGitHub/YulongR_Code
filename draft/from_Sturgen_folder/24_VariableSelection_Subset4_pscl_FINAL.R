#
# 24_VariableSelection_Subset4_pscl_final.R
#
...
FL.LOG    <- paste(Path.log,"24_VariableSelection_Subset4_pscl_final.log",sep="/")	
...
FL.RESL.OUT <- paste(Path.OUT,"24_VariableSelection_Subset4_pscl_final.csv",sep="/")
...
cat(paste("\n24_VariableSelection_Subset4_pscl_final.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n24_VariableSelection_Subset4_pscl_final.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)

cat(paste("\nProcessing time for [24_VariableSelection_Subset4_pscl_final.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [24_VariableSelection_Subset4_pscl_final.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
