#
# 1_Chk_March14_2013DataRevised.R
#
#
# eliminate all stuff
rm(list = ls(all = TRUE))
...
Path.Out     <- "C:/YuLong_Projects/FY2012_MORiver/DataAnalysis/1_Chk_March14_2013DataRevised"
...
# FL.Data.IN <- paste(Path.Data.IN,"Task_Progress_CRVedit_2013Mar8_YLX.csv",sep="/")	# data has been revised by Kyle on Maqrch 12, 2013
FL.Data.IN <- paste(Path.Data.IN,"Task_Progress_KBLedit_2013Mar12_YLX.csv",sep="/")
FL.LOG     <- paste(Path.log,"1_Chk_March14_2013DataRevised.log",sep="/")	
FL.PDF     <- paste(Path.Out,"1_Chk_March14_2013DataRevised.pdf",sep="/")	
FL.SUM.cat <- paste(Path.Out,"1_Chk_March14_2013DataRevised_cat.sum",sep="/")
FL.SUM.num <- paste(Path.Out,"1_Chk_March14_2013DataRevised_num.sum",sep="/")
