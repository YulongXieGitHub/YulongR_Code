#
# 04_DataMining_LargeOffice_PAM_with_NbClust_refine.R 
# 
...
Path.OUT <- paste(Path.Sim,"04_DataMining_LargeOffice_PAM_with_NbClust_refine",sep="/")
...
FL.LOG <- paste(Path.OUT,"04_DataMining_LargeOffice_PAM_with_NbClust_refine.log",sep="/")
...
cat(paste("\n04_DataMining_LargeOffice_PAM_with_NbClust_refine.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n04_DataMining_LargeOffice_PAM_with_NbClust_refine.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [04_DataMining_LargeOffice_PAM_with_NbClust_refine.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [04_DataMining_LargeOffice_PAM_with_NbClust_refine.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
