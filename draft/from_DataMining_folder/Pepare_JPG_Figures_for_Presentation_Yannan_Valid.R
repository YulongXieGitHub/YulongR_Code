#
# Pepare_JPG_Figures_for_Presentation_Yannan_Valid.R 
#
...
Path.OUT <- paste(Path.Sim,"Pepare_JPG_Figures_for_Presentation_Yannan_Valid",sep="/")
...
FL.LOG <- paste(Path.OUT,"Pepare_JPG_Figures_for_Presentation_Yannan_Valid.log",sep="/")
...
{	
	...
	# for (this.idx in seq(1,length(EEMs.name))[1])
	{
		...
		#
		FL.IN.Yannan     <- paste(Path.Script,"labels_Valid.csv",      sep="/")
...
cat(paste("\nPepare_JPG_Figures_for_Presentation_Yannan_Valid.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\nPepare_JPG_Figures_for_Presentation_Yannan_Valid.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Presentation_Yannan_Valid.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Presentation_Yannan_Valid.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
