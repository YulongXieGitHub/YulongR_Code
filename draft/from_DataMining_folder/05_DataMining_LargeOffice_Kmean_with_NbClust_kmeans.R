#
# 05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R 
# 
...
Path.OUT <- paste(Path.Sim,"05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans",sep="/")
...
FL.LOG <- paste(Path.OUT,"05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.log",sep="/")
...
for (this.CZ in CZ.arrays[c(1)])	#for (this.CZ in CZ.arrays)  c("SanFrancisco","Albuquerque")  c(7,9,4,8,3,2,5,6,10,11,12,13,14,15,16,1)
{	
...
cat(paste("\n05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [05_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
