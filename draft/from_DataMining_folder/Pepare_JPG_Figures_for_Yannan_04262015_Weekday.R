#
# Pepare_JPG_Figures_for_Yannan_04262015_Weekday.R 
#
...
Path.OUT <- paste(Path.Sim,"Pepare_JPG_Figures_for_Yannan_04262015_Weekday",sep="/")
...
FL.LOG <- paste(Path.OUT,"Pepare_JPG_Figures_for_Yannan_04262015_Weekday.log",sep="/")
...
cat(paste("\nPepare_JPG_Figures_for_Yannan_04262015_Weekday.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\nPepare_JPG_Figures_for_Yannan_04262015_Weekday.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Yannan_04262015_Weekday.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Yannan_04262015_Weekday.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
