#
# Pepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear.R 
#
...
Path.OUT <- paste(Path.Sim,"Pepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear",sep="/")
...
FL.LOG <- paste(Path.OUT,"Pepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear.log",sep="/")
...
cat(paste("\nPepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\nPepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Presentation_Yannan_04262015_allyear.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
