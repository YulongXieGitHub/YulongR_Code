#
# 04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R 
# 
...
Path.OUT <- paste(Path.Sim,"04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans",sep="/")
...
FL.LOG <- paste(Path.OUT,"04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.log",sep="/")
...
cat(paste("\n04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [04_DataMining_LargeOffice_Kmean_with_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
