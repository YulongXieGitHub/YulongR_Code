#
# 08_DataMining_LargeOffice_PAM_with_NbClust_kmeans.R 
# April 3, 2015
...
Path.OUT <- paste(Path.Sim,"08_DataMining_LargeOffice_PAM_with_NbClust_kmeans",sep="/")
...
FL.LOG <- paste(Path.OUT,"08_DataMining_LargeOffice_PAM_with_NbClust_kmeans.log",sep="/")
 		  ...
 		  for (this.subset in c("all","WeekDay","July","July-August"))
 		{
	      ...
	      row.names(myData.dayMapping) <- myData.dayMapping[,"date"]
			...
			{ 
				...
				if(this.CZ == "Atlanta"      & this.subset == "all"     & this.idx == 6){no.cls.best <- 14}
...
cat(paste("\n08_DataMining_LargeOffice_PAM_with_NbClust_kmeans.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n08_DataMining_LargeOffice_PAM_with_NbClust_kmeans.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [08_DataMining_LargeOffice_PAM_with_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [08_DataMining_LargeOffice_PAM_with_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
