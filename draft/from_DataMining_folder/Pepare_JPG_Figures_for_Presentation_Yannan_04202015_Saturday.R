#
# Pepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday.R 
#
...
Path.OUT <- paste(Path.Sim,"Pepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday",sep="/")
...
FL.LOG <- paste(Path.OUT,"Pepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday.log",sep="/")
...
{	
	...
	# for (this.idx in seq(1,length(EEMs.name))[1])
	{
		...
		#
		FL.IN.Yannan     <- paste(Path.Script,"Saturday_04202015.csv",      sep="/")
		...
		p.daily.Yannan <- p.daily.Yannan + scale_x_discrete(name="Hour in the day",limits=c(12,24))
		dev.set(2)
		plot(p.daily.Yannan)
...
cat(paste("\nPepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\nPepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [Pepare_JPG_Figures_for_Presentation_Yannan_04202015_Saturday.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
