#
# 03_DataMining_LargeOffice_NbClust_kmeans.R 
# 
# March 4, 2015
#
...
Path.OUT <- paste(Path.Sim,"03_DataMining_LargeOffice_NbClust_kmeans",sep="/")
...
FL.LOG <- paste(Path.OUT,"03_DataMining_LargeOffice_NbClust_kmeans.log",sep="/")
 		  ...
 		  for (this.subset in c("artificial1","artificial2","artificial3","July","July-August","WeekDay","Sunday","Saturday","Holiday"))
 		{
	      ...
	      row.names(myData.dayMapping) <- myData.dayMapping[,"date.new"]
			...
			{ 
				...
				cat(paste("34. [",this.CZ,"]-[",this.EEM.name,"]-[",this.subset,"]: NbClust_kmeans modeling.\n",sep=""))
				cat(paste("34. [",this.CZ,"]-[",this.EEM.name,"]-[",this.subset,"]: NbClust_kmeans modeling.\n",sep=""),file=FL.LOG,append=TRUE)	

				cat(paste("35. [",this.CZ,"]-[",this.EEM.name,"]-[",this.subset,"]: NbClust_kmeans predicting.\n",sep=""))
				cat(paste("35. [",this.CZ,"]-[",this.EEM.name,"]-[",this.subset,"]: NbClust_kmeans predicting.\n",sep=""),file=FL.LOG,append=TRUE)	
...
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_NbClust_kmeans.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
