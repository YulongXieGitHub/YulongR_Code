#
# 09_DataMining_LargeOffice_FabricateData.R 
#
# April 3, 2015
...
Path.OUT <- paste(Path.Sim,"09_DataMining_LargeOffice_FabricateData",sep="/")
...
FL.LOG <- paste(Path.OUT,"09_DataMining_LargeOffice_FabricateData.log",sep="/")
...
cat(paste("\n09_DataMining_LargeOffice_FabricateData.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n09_DataMining_LargeOffice_FabricateData.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [09_DataMining_LargeOffice_FabricateData.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [09_DataMining_LargeOffice_FabricateData.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
