#
# 03_DataMining_LargeOffice_Kmean.R 
# 
...
Path.OUT <- paste(Path.Sim,"03_DataMining_LargeOffice_Kmean",sep="/")
...
FL.LOG <- paste(Path.OUT,"03_DataMining_LargeOffice_Kmean.log",sep="/")
...
{	
	...
	for (this.idx in seq(1,length(EEMs.name)))
	{
		...
		# {		
			...
			plot(1:no.cls,wss,type="b",xlab="Number of Clsuters",ylab = "Within Groups Sun of Squares",main=paste(no.cls.best," cluster results seems like the best",sep=""))
...
cat(paste("\n03_DataMining_LargeOffice_Kmean.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n03_DataMining_LargeOffice_Kmean.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [03_DataMining_LargeOffice_Kmean.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_Kmean.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
