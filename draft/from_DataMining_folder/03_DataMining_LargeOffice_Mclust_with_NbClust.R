#
# 03_DataMining_LargeOffice_Mclust_with_NbClust.R 
# 
...
Path.OUT <- paste(Path.Sim,"03_DataMining_LargeOffice_Mclust_with_NbClust",sep="/")
...
FL.LOG <- paste(Path.OUT,"03_DataMining_LargeOffice_Mclust_with_NbClust.log",sep="/")
 		...
 		for (this.subset in c("artificial1","artificial2","artificial3","July","July-August","WeekDay","Sunday","Saturday","Holiday"))
 		{
	      ...
	      row.names(myData.dayMapping) <- myData.dayMapping[,"date.new"]
			...
			{ 
				...
				### no.cls.best  <- dim(d_clust$z)[2]
				cat("model-based optimal number of clusters:", no.cls.best, "\n")
...
cat(paste("\n03_DataMining_LargeOffice_Mclust_with_NbClust.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n03_DataMining_LargeOffice_Mclust_with_NbClust.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [03_DataMining_LargeOffice_Mclust_with_NbClust.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_Mclust_with_NbClust.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
