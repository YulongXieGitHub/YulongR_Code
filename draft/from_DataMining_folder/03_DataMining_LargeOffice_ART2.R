#
# 03_DataMining_LargeOffice_ART2.R 
# 
...
Path.OUT <- paste(Path.Sim,"03_DataMining_LargeOffice_ART2",sep="/")
...
FL.LOG <- paste(Path.OUT,"03_DataMining_LargeOffice_ART2.log",sep="/")
...
cat(paste("\n03_DataMining_LargeOffice_ART2.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n03_DataMining_LargeOffice_ART2.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [03_DataMining_LargeOffice_ART2.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_ART2.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
