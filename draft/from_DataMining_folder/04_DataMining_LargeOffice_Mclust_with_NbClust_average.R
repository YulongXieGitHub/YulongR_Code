#
# 04_DataMining_LargeOffice_Mclust_with_NbClust_average.R 
# 
# 
...
Path.OUT <- paste(Path.Sim,"04_DataMining_LargeOffice_Mclust_with_NbClust_average",sep="/")
...
FL.LOG <- paste(Path.OUT,"04_DataMining_LargeOffice_Mclust_with_NbClust_average.log",sep="/")
		...
		cat(paste("21. [",this.CZ,"]-[",this.EEM.name,"]: to avoid worngly taking existing data frame, delete them first..\n",sep=""),file=FL.LOG,append=TRUE)	
 		...
 		for (this.subset in c("artificial1","artificial2","artificial3","July","July-August","WeekDay","Sunday","Saturday","Holiday"))
 		{
	      ...
	      row.names(myData.dayMapping) <- myData.dayMapping[,"date.new"]
			...
			# continue run even is there is an error
			# tryCatch({
...
cat(paste("\n04_DataMining_LargeOffice_Mclust_with_NbClust_average.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n04_DataMining_LargeOffice_Mclust_with_NbClust_average.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [04_DataMining_LargeOffice_Mclust_with_NbClust_average.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [04_DataMining_LargeOffice_Mclust_with_NbClust_average.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
