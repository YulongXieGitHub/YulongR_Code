#
# 03_DataMining_LargeOffice_PAM.R 
# 
...
Path.OUT <- paste(Path.Sim,"03_DataMining_LargeOffice_PAM",sep="/")
...
FL.LOG <- paste(Path.OUT,"03_DataMining_LargeOffice_PAM.log",sep="/")
...
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_PAM.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_PAM.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
