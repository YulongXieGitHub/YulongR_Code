#
# 03_DataMining_LargeOffice_Mclust.R 
# 
...
Path.OUT <- paste(Path.Sim,"03_DataMining_LargeOffice_Mclust",sep="/")
...
FL.LOG <- paste(Path.OUT,"03_DataMining_LargeOffice_Mclust.log",sep="/")
...
cat(paste("\n03_DataMining_LargeOffice_Mclust.R is finished successfully at ",End.time,"!\n",sep=" "))
cat(paste("\n03_DataMining_LargeOffice_Mclust.R is finished successfully at ",End.time,"!\n",sep=" "),file=FL.LOG,append=TRUE)


cat(paste("\nProcessing time for [03_DataMining_LargeOffice_Mclust.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "))
cat(paste("\nProcessing time for [03_DataMining_LargeOffice_Mclust.R] is ",as.numeric(Diff.time, units="mins")," minutes\n",sep=" "),file=FL.LOG,append=TRUE)
